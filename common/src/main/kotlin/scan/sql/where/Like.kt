...
@PublishedApi internal inline fun <reified T:Table, reified V:DTO> Where._like(field:KProperty1<T, String>, bind:KProperty1<V, String>, noinline converter:(Any)->Any):WhereAnd{
    data.addBind<V>(Bind(field.name, converter))
    data.where().add(Like(T::class.tableName(), field.name, bind.name))
...
inline fun <reified T:Table, reified V:DTO> Where.like(field:KProperty1<T, String>, bind:KProperty1<V, String>):WhereAnd
= _like(field, bind, likeAll)
inline fun <reified T:Table, reified V:DTO> Where.likeLeft(field:KProperty1<T, String>, bind:KProperty1<V, String>):WhereAnd
= _like(field, bind, likeLeft)
inline fun <reified T:Table, reified V:DTO> Where.likeRight(field:KProperty1<T, String>, bind:KProperty1<V, String>):WhereAnd
